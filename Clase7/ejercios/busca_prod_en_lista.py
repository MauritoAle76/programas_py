...
# En la tupla cargamos el User y la Pass
# usuario , contraseña
tupla_id_passw = ("mauro", 1123)

indice_user = 0
# se le pide ingresar  el usuario y contraseña

while indice_user < 3:
    user = input("ingrese  su nombre de usuario: ").lower()
    passw = input("ingrese su contraseña, 6 digitos: ")
    indice_user += 1
    # validacion de los datos ingresados
    if user == tupla_id_passw[0] and passw == str(tupla_id_passw[1]):
        print()
        ...
        # En la versión final tendremos una función que trae los datos de la DB
            ...
            while indice < len(lista_productos):
                ...
                if producto_consultado == producto_buscado[1]:
                    ...
                    encontrado = True  # cuando encuentra el producto reasigna la variable con True
                    break
                indice = (
                    indice + 1
